...
RSpec.describe ApplicationHelper, type: :helper do
  ...
  describe '#render_tabs' do
    ...
    it 'highlights the selected tab' do
      ...
      expect(html).to have_css('a.bg-indigo-100.text-indigo-900', text: 'Company')
    end
    ...
    it 'does not highlight non-selected tabs' do
      ...
      puts html
      expect(html).to have_css('a.text-gray-500', text: 'My Account')
      expect(html).to have_css('a.text-gray-500', text: 'Team Members')
    end

module ThemeHelper
  ...
  def task_css(task)
    ...
    task_done_css = 'bg-gray-100 dark:bg-gray-950 border-gray-50 dark:border-gray-800 line-through dark:decoration-gray-400 text-gray-600 dark:text-gray-400'.freeze
    task_todo_css = 'bg-white dark:bg-gray-900 border-gray-100 dark:border-gray-800 text-black dark:text-neutral-200'.freeze

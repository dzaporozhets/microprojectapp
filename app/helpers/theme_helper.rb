module ThemeHelper
  ...
  def theme_ring
    case theme_name
    when 'violet' then 'ring-violet-500'
    when 'lime' then 'ring-lime-500'
    when 'pink' then 'ring-pink-500'
    when 'sky' then 'ring-sky-500'
    when 'orange' then 'ring-orange-500'
    when 'indigo' then 'ring-indigo-500'
    when 'gray' then 'ring-gray-500'
    end
  end
